...
// binary to a lamp. A corrupt copy is dropped without burning the
// lamp's flash bandwidth.
...
/// Footer offsets. Must match sign_firmware.py's struct layout exactly.
///
///   offset  size  field
///   0       4     magic "LSIG"
...
LsigFooter parseLsigFooter(Uint8List signedImage) {
  ...
  // against a different blob. The receiver would also reject this; caught
  // here so the user sees "corrupt download" not "lamp refused the offer".
