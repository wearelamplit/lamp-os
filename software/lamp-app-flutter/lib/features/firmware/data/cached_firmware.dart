...
/// channel field. `path` is the absolute file path; `version` is the
/// packed semver parsed from the verified LSIG footer; `fetchedAtMs` is
/// the wall-clock timestamp of the download (epoch millis).
