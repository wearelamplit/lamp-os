...
// decide whether the WiFi has internet. MUST return a redirect, not a 200 with
// a body — Android's captive popup treats any 200 from /generate_204 as a
// diagnostic dump and renders the body as raw text (regardless of
// Content-Type). Redirecting to "/" makes the popup follow it as a normal
// navigation and load the Vue SPA, which the popup may render imperfectly;
// users who need full functionality should open http://192.168.4.1 in a
// regular browser.
