...
// =============================================================================
// control_op.hpp — MSG_CONTROL_OP (0x03), a forwarded BLE control write.
...
//   12    6    sourceMac
//   18    2    payloadLen (LE)
//   20    N    payload (opaque; JSON in practice, ≤ CONTROL_MAX_PAYLOAD = 230)
//
// Fixed prefix is CONTROL_FIXED (20); whole frame ≤ CONTROL_MAX_SIZE (250).
