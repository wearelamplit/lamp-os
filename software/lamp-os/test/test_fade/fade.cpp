...
// Mirror of src/util/fade.cpp LUTs. constexpr ⇒ .rodata, no heap.
// Size 511 matches the source data (the audit said "512-entry" but the
// actual table is 511 entries; max LUT index reachable from ease() is 510
