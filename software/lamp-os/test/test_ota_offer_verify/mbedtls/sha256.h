...
// to the include path (via the test_firmware_signature/-I flag implied
// by PIO's per-test src layout) and ships a self-contained, public-
// domain SHA-256 implementation that mirrors the subset of mbedtls's API
