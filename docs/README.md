...
- [`dev/`](dev/), the **developer handbook** and reference guides (the
  architecture map, custom lamps, the mesh wire-format spec, expressions,
  personality). Start at [`dev/README.md`](dev/README.md).
