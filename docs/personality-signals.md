...
shape it produces is documented in `docs/personality-greetings.md`.
...
- `docs/personality-greetings.md` — the behavioral / visual side of
  greetings: what profiles look like, the cooldown + fatigue rules.
- `docs/lamp-framework.md` — how to author a custom lamp variant.
